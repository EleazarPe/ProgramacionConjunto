...
public class RegistroVacuna extends JDialog {
	...
	public RegistroVacuna() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			lblNewLabel_8.setBounds(413, 11, 92, 14);
			panel_2.add(lblNewLabel_8);
			
			txtFecha = new JTextField();
			txtFecha.setEditable(false);
			txtFecha.setBounds(406, 25, 166, 20);
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					////////////////////////////////////////////////////////------------------------------>>>>>>>>>>>>>>
					Vacuna auxiliarVacuna = Clinica.getInstance().buscarVacunabyCedula(txtCedula.getText());
